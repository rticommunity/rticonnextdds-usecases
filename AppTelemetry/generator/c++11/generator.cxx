...
void PublishUint64Counter(dds::pub::DataWriter< ::Metrics::Metric> &writer, const int counter)
{
    ...
    AddLabel(metric, 
        "status",
        (val <= 1000 ? "good" : val > 1000 && val <= 5000 ? "warning" : "error"));
...
void PublishUInt64UpDownCounter(dds::pub::DataWriter< ::Metrics::Metric> &writer, const int counter) {
    ...
    AddLabel(metric, 
        "status",
        (counter_uint <= 1000 ? "good" : counter_uint > 1000 && counter_uint <= 5000 ? "warning" : "error"));
...
void PublishDoubleUpDownCounter(dds::pub::DataWriter< ::Metrics::Metric> &writer, const int counter) {
    ...
    AddLabel(metric, 
        "status",
        (counter_double <= 1000 ? "good" : counter_double > 1000 && counter_double <= 5000 ? "warning" : "error"));
...
void PublishInt64Gauge(dds::pub::DataWriter< ::Metrics::Metric> &writer, const int counter) {
    ...
    AddLabel(metric, 
        "status",
        (val <= 333 ? "good" : val > 333 && val <= 666 ? "warning" : "error"));
