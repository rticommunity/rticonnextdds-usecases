...
The respository contains examples that illustrate a variety of distributed 
system use cases, from vehicle tracking to manufacturing and automation.  Some
of the use case examples will be focused on real applications such as air 
traffic control, and some will be focused on deployment scenarios such as 
connecting real-time networks over the cloud.
