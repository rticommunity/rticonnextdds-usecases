...
if (ARCHITECTURE MATCHES "Linux")
    ...
    add_custom_target(
        RUN_RTIDDSGEN
        COMMAND ${NDDSHOME}/scripts/rtiddsgen ${CMAKE_SOURCE_DIR}/Idl/ChocolateFactory.idl -namespace -replace -language C++ -d ${CMAKE_SOURCE_DIR}/Generated 
    )
elseif(ARCHITECTURE MATCHES "Win32")
    set(CONNEXTDDS_DEFINITIONS "-DWIN32_LEAN_AND_MEAN -DWIN32 -D_WINDOWS -DRTI_WIN32 -D_BIND_TO_CURRENT_MFC_VERSION=1 -D_BIND_TO_CURRENT_CRT_VERSION=1 -D_CRT_SECURE_NO_WARNING")
    if (CMAKE_BUILD_TYPE MATCHES "Debug")
        set(CONNEXTDDS_DEFINITIONS ${CONNEXTDDS_DEFINITIONS} "-DRTI_PRECONDITION_TEST")
